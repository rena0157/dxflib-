...
namespace dxflib::entities
{
	namespace group_codes
	{
		...
		public:
			...
			const vertex& get_first_alignment() const { return first_alignment_; }   // Returns the first alignment vertex
			const vertex& get_second_alignment() const { return second_alignment_; } // Returns the second alignment vertex
			double text_height() const { return text_height_; }                      // Returns the text height
